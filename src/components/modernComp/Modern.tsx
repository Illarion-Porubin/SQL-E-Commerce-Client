  ...
  return (
    <div className={s.modern}>
      <div className={s.modern__main_content}>
        <img className={s.modern__main_img} src={modern_1} alt="img" />
        <div className={s.modern__main_info}>
          <p className={s.modern__main_title}>Modern Furniture Collections</p>
      ...
      <div className={s.modern__dop_content}>
        <div className={s.modern__dop_item}>
          <img className={s.modern__dop_img} src={modern_2} alt="img" />
          <div className={s.modern__dop_info}>
            <p className={s.modern__dop_title}>Modern Furniture Collections</p>
